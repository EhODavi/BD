...
ALTER TABLE `tbreservalivro`
  ...
  UPDATE TbLivro SET Preco = 100 WHERE CdLivro = 1;
    UPDATE TbLivro SET Preco = 100 WHERE CdLivro = 2;
      UPDATE TbLivro SET Preco = 100 WHERE CdLivro = 3;
        UPDATE TbLivro SET Preco = 100 WHERE CdLivro = 4;
        
SELECT NmAluno, Dtemprestimo, DtPrevistaDev FROM TbAluno A left JOIN TbEmprestimo E ON A.CdAluno = E.CdAluno ORDER BY NmAluno;

SELECT NmLivro, NmArea FROM TbLivro L RIGHT JOIN TbArea A ON A.CdArea = L.CdArea;

SELECT NmArea, AVG(Preco) as Media FROM TbArea A LEFT JOIN TbLivro L ON A.CdArea = L.CdArea GROUP BY A.CdArea; 